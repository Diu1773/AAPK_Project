...
from ...utils.step_paths import step2_cropped_dir, step5_dir, step9_dir, crop_is_active
...
class ApertureWorker(QThread):
    ...
    def run(self):
        try:
            ...
            apcorr_small_scale = float(getattr(P, "apcorr_small_scale", 1.0))
            apcorr_large_scale = float(getattr(P, "apcorr_large_scale", 3.0))
