...
### Light Curve Scaffold
- Added light curve GUI tabs for variable, eclipsing, and asteroid targets.
- Added light curve analysis module placeholders and loader helpers.
- Updated workflow: target/comparison selection, selection-only photometry, and light curve builder step.
- Default detection engine set to DAO with updated parameters.
